...
{
public:
	bool operator() (const IController_AutoPtr& a, const IController_AutoPtr& b) { CRYASSERT(a != (IController*)nullptr && b != (IController*)nullptr); return a->GetID() < b->GetID(); }
	bool operator() (const IController_AutoPtr& a, unsigned nID) { CRYASSERT(a != (IController*)nullptr); return a->GetID() < nID; }
};
