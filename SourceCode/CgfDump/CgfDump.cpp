...
void printChunkMtl(const MTL_CHUNK_DESC_0746* pChunk, int nSize)
{
	...
	case MTL_STANDARD:
		...
		print("Ambient", pChunk->tex_a);
		print("Diffuse", pChunk->tex_d);
		print("Specular", pChunk->tex_s);
		print("Opacity", pChunk->tex_o);
		print("Bump", pChunk->tex_b);
		print("Gloss", pChunk->tex_g);
		print("Filter", pChunk->tex_fl);
		print("Reflection", pChunk->tex_rl);
		print("Subsurface", pChunk->tex_subsurf);
		print("Detail", pChunk->tex_det);
