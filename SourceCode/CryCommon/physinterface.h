...
struct pe_simulation_params : pe_params { // Sets gravity and maximum time step
	...
	pe_simulation_params() {
		type = type_id; MARK_UNUSED maxTimeStep, gravity, minEnergy, damping, iSimClass,
...
struct pe_params_softbody : pe_params {
	...
	pe_params_softbody() {
		type = type_id; MARK_UNUSED thickness, maxSafeStep, ks, kdRatio, airResistance, wind, nMaxIters,
...
enum meshflags {
	mesh_OBB = 1, mesh_AABB = 2, mesh_SingleBB = 4, mesh_multicontact0 = 8, mesh_multicontact1 = 16, mesh_multicontact2 = 32,
...
enum rwi_flags {
	rwi_ignore_terrain_holes = 0x20, rwi_ignore_noncolliding = 0x40, rwi_ignore_back_faces = 0x80, rwi_any_hit = 0x100,
