...
{
	ERF_SELFSHADOW					= 0x1,
	ERF_CASTSHADOWVOLUME			= 0x2,
	ERF_RECVSHADOWMAPS				= 0x4,
	ERF_CASTSHADOWMAPS				= 0x8,
	ERF_DONOTCHECKVIS         		= 0x10,
	ERF_CASTSHADOWINTOLIGHTMAP		= 0x20,
	ERF_HIDABLE						= 0x40,
	ERF_HIDDEN						= 0x80,
	ERF_SELECTED					= 0x100,
	ERF_USELIGHTMAPS				= 0x200,
	ERF_OUTDOORONLY					= 0x400,
	ERF_UPDATE_IF_PV				= 0x800,
	ERF_EXCLUDE_FROM_TRIANGULATION	= 0x1000,
	ERF_MERGED						= 0x2000,
	ERF_RECVSHADOWMAPS_ACTIVE		= 0x4000,
	ERF_PHYS_NONCOLL				= 0x8000,
	ERF_MERGED_NEW  				= 0x10000,
	ERF_FIRST_PERSON_CAMERA_OWNER	= 0x20000,

	// Should be the same as FOB_ flags
	ERF_NOTRANS_ROTATE  			= 0x10000000,
	ERF_NOTRANS_SCALE 				= 0x20000000,
	ERF_NOTRANS_TRANSLATE			= 0x40000000,

	ERF_NOTRANS_MASK				= (ERF_NOTRANS_ROTATE | ERF_NOTRANS_SCALE | ERF_NOTRANS_TRANSLATE)
};
