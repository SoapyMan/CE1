...
bool CInputDirectInput::Init(ISystem* pSystem, void* hinst, void* hwnd)
{
	m_pSystem = pSystem;
...
#ifndef _XBOX
	if (!m_Keyboard.Init(this, m_pSystem, m_g_pdi, m_hinst, m_hwnd))
		return (false);
	m_pLog->LogToFile("Keyboard initialized\n");

	if (!m_Mouse.Init(this, m_pSystem, m_g_pdi, m_hinst, m_hwnd, true))
		return false;
...
///////////////////////////////////////////
void CInputDirectInput::ShutDown()
{
...
///////////////////////////////////////////
void CInputDirectInput::Update(bool bFocus)
{
	if (bFocus)
	{
...
void CInputDirectInput::ClearKeyState()
{
...
///////////////////////////////////////////////
IActionMapManager* CInputDirectInput::CreateActionMapManager()
{
...
///////////////////////////////////////////////
const char* CInputDirectInput::GetKeyName(int iKey, int modifiers, bool bGUI)
{
...
bool CInputDirectInput::GetOSKeyName(int nKey, wchar_t* szwKeyName, int iBufSize)
{
...
int CInputDirectInput::VK2XKEY(int nKey)
{
	//#ifdef DEBUG_KEYBOARD
	switch (nKey)
	{
...
//////////////////////////////////////////////////////////////////////////
int CInputDirectInput::GetKeyID(const char* sName)
{
	if (!sName)
	{
		return XKEY_NULL;
...
//////////////////////////////////////////////////////////////////////////
const char* CInputDirectInput::GetXKeyPressedName()
{
...
//////////////////////////////////////////////////////////////////////////
void CInputDirectInput::AddEventListener(IInputEventListener* pListener)
{
...
//////////////////////////////////////////////////////////////////////////
void CInputDirectInput::RemoveEventListener(IInputEventListener* pListener)
{
...
//////////////////////////////////////////////////////////////////////////
void CInputDirectInput::AddConsoleEventListener(IInputEventListener* pListener)
{
...
//////////////////////////////////////////////////////////////////////////
void CInputDirectInput::RemoveConsoleEventListener(IInputEventListener* pListener)
{
...
//////////////////////////////////////////////////////////////////////////
void CInputDirectInput::EnableEventPosting(bool bEnable)
{
	m_postingenable = bEnable;
}

//////////////////////////////////////////////////////////////////////////
void CInputDirectInput::PostInputEvent(const SInputEvent& event)
{
	if (m_postingenable)
	{
...
//////////////////////////////////////////////////////////////////////////
void CInputDirectInput::BroadcastEvent(const SInputEvent& event)
{
	if (!m_postingenable)
	{
		return;
...
//////////////////////////////////////////////////////////////////////////
void CInputDirectInput::SetExclusiveListener(IInputEventListener* pListener)
{
	m_exclusivelistener = pListener;
}

//////////////////////////////////////////////////////////////////////////
IInputEventListener* CInputDirectInput::GetExclusiveListener()
{
	return m_exclusivelistener;
}

//////////////////////////////////////////////////////////////////////////
int CInputDirectInput::GetModifiers() const
{
